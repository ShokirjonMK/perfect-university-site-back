...
urlpatterns = [
    path("", login_required(views.VacancyFormList.as_view()), name="form-list"),
    path("create/", login_required(views.VacancyFormCreate.as_view()), name="form-create"),
    path("update/<int:pk>/", login_required(views.VacancyFormUpdate.as_view()), name="form-update"),
    path("delete/<int:pk>/", login_required(views.VacancyFormDelete.as_view()), name="form-delete"),
